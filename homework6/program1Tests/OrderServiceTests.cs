...
namespace program1.Tests
{
    ...
    public class OrderServiceTests
    {
        ...
        public void AddOrderTest()
        {
            try
            {
                Order order = new Order("Jeff", "test1");
                OrderService service = new OrderService();
                service.AddOrder(order);
                service.CheckByClient("Jeff");
            }
            catch (Exception e)
            {
        ...
        public void CheckByClientTest()
        {
            ...
            OrderService service = new OrderService();
            service.AddOrder(order);
            List<Order> list = service.CheckByClient("Jeff");
        ...
        public void CheckOverTenThousandTest()
        {
            ...
            Assert.AreEqual(list[0].Client, "Jeff");
        }
